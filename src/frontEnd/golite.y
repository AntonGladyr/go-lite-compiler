...
var_decl : tVAR id_listne type { $$ = NULL; }
    | tVAR id_listne tASSIGN exp_list { $$ = NULL; }
    | tVAR id_listne type tASSIGN exp_list { $$ = NULL; }
    ;

type_decl : tTYPE tIDENTIFIER type { /*$$ = new TypeDeclaration($2, $3);*/ } 
    ;

func_decl : tFUNC tIDENTIFIER tLPAREN paramspe tRPAREN block_stmt { $$ = NULL; }
    | tFUNC tIDENTIFIER tLPAREN paramspe tRPAREN type block_stmt { $$ = NULL; }
    ;
